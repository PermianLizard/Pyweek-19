...
METADATA = {
    ...
    #'author_email':     '',
    'url':              'https://pyweek.org/e/Silurian/',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'DungeonSquabble': 'DungeonSquabble',
                   },
    'packages': ['DungeonSquabble',
                ],
    'scripts': ['scripts/DungeonSquabble'],
}
...
_DATA_DIR = os.path.join('DungeonSquabble', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'DungeonSquabble': data_dirs}
...
src = []
add_files(src,os.walk('DungeonSquabble'))
