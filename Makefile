#fake Makefile for DungeonSquabble, to support the common
...
clean:
	...
	rm -f DungeonSquabble/*~
	rm -rf bin develop-eggs eggs parts .installed.cfg DungeonSquabble.egg-info
